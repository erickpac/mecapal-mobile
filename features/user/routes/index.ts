...
export const navigateToAddressesIndex = () =>
...
export const navigateToSecurityIndex = () =>
  router.push(USER_ROUTES.SECURITY_INDEX);
export const navigateToChangePassword = () =>
  router.push(USER_ROUTES.SECURITY_CHANGE_PASSWORD);
export const navigateToTwoFactor = () =>
  router.push(USER_ROUTES.SECURITY_TWO_FACTOR);
export const navigateToDevices = () =>
  router.push(USER_ROUTES.SECURITY_DEVICES);
